...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Edit Profil - Perpus</title>
								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-9">
											...
											<form class="form-horizontal" action="{{route('update.perpus',$row->id)}}" method="post">
											{{ csrf_field() }}
												<div class="form-group">
													<label class="col-sm-4 control-label no-padding-right" for="username">Username</label>

													<div class="col-sm-8">
														<input class="col-xs-12 col-sm-10" type="text" id="username" placeholder="Username" name="username" value="{{$row->username}}" readonly="true" />
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input class="col-xs-12 col-sm-10" type="text" id="nama" placeholder="Nama" name="nama" value="{{$row->nama}}" />
													</div>
												</div>
											...
											<form class="form-horizontal" action="{{route('foto.perpus',$row->id)}}" method="post" enctype="multipart/form-data">
											{{ csrf_field() }}
											...
											<form class="form-horizontal" action="{{route('pw.perpus',$row->id)}}" method="post">
											{{ csrf_field() }}
