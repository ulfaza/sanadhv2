								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-9">
											...
											<form class="form-horizontal" action="{{route('foto.siswa',$row->id)}}" method="post" enctype="multipart/form-data">
											{{ csrf_field() }}
											...
											<form class="form-horizontal" action="{{route('pw.siswa',$row->id)}}" method="post">
											{{ csrf_field() }}
