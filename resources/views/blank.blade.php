        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Blank Page</h1>
            </div>
          </div>
        </div> 
      </div>           
    ...
    <section id="profil" class="section">
      <div class="container">
        <div class="section-header">          
          ...
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Content</p>
        </div>
      </div>
    </section>
    <!-- Profil Section End -->
