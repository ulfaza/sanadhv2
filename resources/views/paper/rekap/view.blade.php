...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>	Rekapitulasi - Paper</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h4>
								Rekapitulasi Paper Kelas {{ $tingkat }}
								<!-- <a style="float: right; margin-left: 10px" href="{{route('import.rekap', $tingkat)}}" class="btn btn-xs btn-success">
									Import Rekapan
								</a> -->
							</h4>
						</div><!-- /.page-header -->
