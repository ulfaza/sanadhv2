					            ...
					            <table id="datatable" class="table table-bordered table-striped">
					              ...
					              <tbody>
					                ...
					                <tr>
					                  ...
					                  <td>
										<div class="btn-group">
											<a href="{{route('view.asesor', $row->tingkat)}}" class="btn btn-xs btn-success">
												Edit Asesor
											</a>
											<a href="{{route('rekap.asesor', $row->tingkat)}}" class="btn btn-xs btn-success">
												Rekap ACC Judul
											</a>
										</div>
									  </td>
