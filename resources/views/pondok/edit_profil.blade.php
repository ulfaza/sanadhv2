...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Edit Profil - Pondok</title>
								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-9">
											...
											<form class="form-horizontal" action="{{route('foto.pondok',$row->id)}}" method="post" enctype="multipart/form-data">
											{{ csrf_field() }}
											...
											<form class="form-horizontal" action="{{route('pw.pondok',$row->id)}}" method="post">
											{{ csrf_field() }}
