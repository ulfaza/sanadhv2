							...
							<div class="col-xs-12">
								...
								<form action="{{route('update.asesmen', [$th_lulus, $row->s_id])}}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select  id="tg_ujian" name="tg_ujian" class="select col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="ket_ujian" name="ket_ujian" rows="5" cols="50">{{ $row->ket_ujian }}</textarea>
										</div>
									</div>
