				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h4>
								Edit Tanggungan Keamanan Putra
							</h4>
						</div><!-- /.page-header -->
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="{{route('update.aman', [$th_lulus, $row->s_id])}}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select  id="tg_aman_pa" name="tg_aman_pa" class="select col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="nominal_aman_pa" name="nominal_aman_pa" value="{{ $row->nominal_aman_pa }}" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="ket_aman_pa" name="ket_aman_pa" rows="5" cols="50">{{ $row->ket_aman_pa }}</textarea>
										</div>
									</div>
