							...
							<div class="col-xs-12">
								...
								<form action="{{route('update.paper', [$th_lulus, $row->s_id])}}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select  id="tg_paper" name="tg_paper" class="select col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="ket_paper" name="ket_paper" rows="5" cols="50">{{ $row->ket_paper }}</textarea>
										</div>
									</div>
