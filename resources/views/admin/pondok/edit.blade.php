							...
							<div class="col-xs-12">
								...
								<form action="{{route('update.pondok', [$th_lulus, $row->s_id])}}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select  id="tg_pondok" name="tg_pondok" class="select col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="nominal_pondok" name="nominal_pondok" value="{{ $row->nominal_pondok }}" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="ket_pondok" name="ket_pondok" rows="5" cols="50">{{ $row->ket_pondok }}</textarea>
										</div>
									</div>
