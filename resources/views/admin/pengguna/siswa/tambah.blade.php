...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Tambah Akun Siswa - Admin</title>
		...
		<div class="content-wrapper">
			<div class="content-header">
			    <div class="container-fluid">
			        <div class="row mb-2">
			            <div class="col-sm-6">
			                <h5 class="m-0">Tambah Akun Siswa</h5>
			            </div>
			            <!-- /.col -->
			            <div class="col-sm-6">
			            ...
			            <div class="col-12">
			                <div class="card">
			                    <div class="card-header">
			                        <h3 class="card-title">Tambah Akun Siswa</h3>
			                    </div>
			                    <div class="card-body">
			                    	<div class="row">
                                		<div class="col-sm-5">
                                			@yield('content')
											<form action="{{route('simpan.akun.siswa')}}" method="post" class="form-horizontal" role="form" >
												{{ csrf_field() }}
