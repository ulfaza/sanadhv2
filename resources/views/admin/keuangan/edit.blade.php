							...
							<div class="col-xs-12">
								...
								<form action="{{route('update.keu', [$th_lulus, $row->s_id])}}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select  id="tg_keuangan" name="tg_keuangan" class="select col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="nominal" name="nominal" value="{{ $row->nominal }}" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="ket_keuangan" name="ket_keuangan" rows="5" cols="50">{{ $row->ket_keuangan }}</textarea>
										</div>
									</div>
