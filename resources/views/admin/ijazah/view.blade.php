...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Tanggungan Ijazah {{ $th_lulus }} - Admin</title>
		...
		<div class="content-wrapper">
			<div class="content-header">
			    <div class="container-fluid">
			        <div class="row mb-2">
			            <div class="col-sm-6">
			                <h5 class="m-0">Tanggungan Ijazah {{ $th_lulus }} </h5>
			            </div>
			            <!-- /.col -->
			            <div class="col-sm-6">
			                <ol class="breadcrumb float-sm-right">
			                    <li class="breadcrumb-item"><a href="{{route('adminhome')}}">Home</a></li>
			                    <li class="breadcrumb-item"><a href="{{route('index.ijazah')}}">Tanggungan Ijazah</a></li>
			                    <li class="breadcrumb-item active">Tanggungan Ijazah {{ $th_lulus }}</li>
			                </ol>
			            </div>
			            <!-- /.col -->
			        </div>
			            ...
			            <div class="col-12">
			                <div class="card">
			                    <div class="card-header">
			                        <h3 class="card-title">Tanggungan Ijazah {{ $th_lulus }}</h3>
			                        <div class="float-right">
			                        	<a class="btn btn-sm btn-success">Ijazah Terambil: {{ $terambil }}</a>
			                        	<a>
