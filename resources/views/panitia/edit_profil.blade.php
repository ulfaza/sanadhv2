								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										...
										<div class="col-xs-12 col-sm-9">
											...
											<form class="form-horizontal" action="{{route('update.panitia',$row->id)}}" method="post">
											{{ csrf_field() }}
											...
											<form class="form-horizontal" action="{{route('foto.panitia',$row->id)}}" method="post" enctype="multipart/form-data">
											{{ csrf_field() }}
											...
											<form class="form-horizontal" action="{{route('pw.panitia',$row->id)}}" method="post">
											{{ csrf_field() }}
